...
// ----- Array Destructuring ------
var racers = ["Anakin", "Gasgano", "Aldar Beedo", "Ebe E. Endocott", "Kathryn"];
// ES5
var first = racers[0]; // Anakin
var second = racers[1]; // Gasgano
var others = racers.slice(racers.length-2); // ['Aldar Beedo', 'Ebe E. Endocott']
...
console.log(others); // ['Aldar Beedo', 'Ebe E. Endocott', 'Kathryn the Jedi']
