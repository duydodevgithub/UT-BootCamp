...
* Replace your React App's `src` folder with [Unsolved/src](Unsolved/src), and start the application in development mode by running `yarn start` in your terminal.
