...
* Run `yarn start` in your terminal to start the application in development mode. Open [localhost:3000](http://localhost:3000) in your web browser and take a moment to study the rendered app.
